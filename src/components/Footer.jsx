                    ...
                    <div className="row footer-widget-wrapper pt-100 pb-70">
                        ...
                        <div className="col-md-6 col-lg-3">
                            <div className="footer-widget-box list">
                                ...
                                <ul className="footer-list">
                                    <li><a href="#"><i className="fas fa-caret-right"></i> Campus Safety</a></li>
                                    <li><a href="#"><i className="fas fa-caret-right"></i> Student Activities</a></li>
                                    <li><a href="#"><i className="fas fa-caret-right"></i> Academic Department</a></li>
                                    <li><a href="#"><i className="fas fa-caret-right"></i> Planning & Administration</a></li>
                                    <li><a href="#"><i className="fas fa-caret-right"></i> Office Of The Chancellor</a></li>
                                    <li><a href="#"><i className="fas fa-caret-right"></i> Facility Services</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3">
